...
def fetch_all_insights():
    ...
    url_inicial = (
        "https://graph.facebook.com/v22.0/act_{account_id}/insights?time_increment=1&time_range=%7B%22since%22%3A%20%222024-12-03%22%2C%20%22until%22%3A%20%222025-02-26%22%7D&level=ad&fields=impressions,%20account_id,reach,spend,adset_id,adset_name,ad_id,ad_name,actions&action_breakdowns=action_type&access_token='Token de acesso'&limit=25&after=MzE1Mjg2Mzc2NjAzOTc1NjkZD"
    )
    ...
    nome_arquivo = f"{account_id}_arquivo.json"
